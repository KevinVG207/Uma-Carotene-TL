...
class Ui_story_speakers(QDialog):
    ...
    def setupUi(self):
        ...
        for i, speaker_data in enumerate(self.speakers_list):
            ...
            txt_source = QPlainTextEdit(grp_speaker)
            ...
            txt_source.setLineWrapMode(QPlainTextEdit.NoWrap)
            ...
            txt_en = QPlainTextEdit(grp_speaker)
            ...
            txt_en.setLineWrapMode(QPlainTextEdit.NoWrap)
